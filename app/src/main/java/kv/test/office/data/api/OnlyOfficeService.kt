...
interface OnlyOfficeService {
    ...
    suspend fun getTrash(@Header("Authorization") token:String): FilesResponse

    @GET("api/2.0/files/rooms")
    suspend fun getRooms(@Header("Authorization") token:String): FilesResponse
